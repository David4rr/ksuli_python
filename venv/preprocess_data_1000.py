...
import os
import pandas as pd
from make_folder import DATA_PATH, actions, sequence_length
...
for action in actions:
    for sequence in range(100):  # Ambil hanya 100 sequence per kategori
        window = []
...
np.savez_compressed(
    r'C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\preprocessed_1000_data.npz',
    X_train=X_train, X_test=X_test, y_train=y_train, y_test=y_test
)

print("\n✅ Preprocessing selesai & disimpan ke NPZ!")
