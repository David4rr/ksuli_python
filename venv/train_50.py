...
data = np.load(r'C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\preprocessed_500_data.npz')
...
# Model LSTM dengan Regularization
...
model_path = r"C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\output\bilstm_model_50(7).h5"
...
history_csv_path = r"C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\model\training_history_bilstm_50(7).csv"
...
# === Info Data Save ===
info_path = r"C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\model\data_info_bilstm_50(6).txt"
...
# history_df = pd.DataFrame(history.history)
# history_df['epoch'] = history_df.index + 1
# history_csv_path = r"C:\Users\david\Documents\my private document\Skripsi Project\KSULI_Bisindo\model\training_history_bilstm50(1).csv"
# history_df.to_csv(history_csv_path, index=False)
# print(f"📊 History training disimpan di {history_csv_path}")